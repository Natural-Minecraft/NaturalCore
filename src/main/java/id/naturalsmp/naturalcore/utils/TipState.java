...
private final NaturalCore plugin;private List<String>tips;private long intervalHooks;private int stayDurationTicks;private String soundName;private org.bukkit.configuration.file.FileConfiguration tipsConfig;

private long lastRun=System.currentTimeMillis();private TipState state=TipState.IDLE;

private String currentTip="";

private int animationFrame=0;private final int MAX_FRAMES=20; // Length of transition
