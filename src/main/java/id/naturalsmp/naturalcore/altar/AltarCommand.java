...
public class AltarCommand implements CommandExecutor {
    ...
    private void handleSetPos1(Player player) {
        ...
        altarManager.setPos1(player.getTargetBlock(null, 5).getLocation());
    ...
    private void handleSetPos2(Player player) {
        ...
        altarManager.setPos2(player.getTargetBlock(null, 5).getLocation());
    ...
    private void handleSetTrigger(Player player) {
        ...
        altarManager.setTriggerLocation(player.getTargetBlock(null, 5).getLocation());
