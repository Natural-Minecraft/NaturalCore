...
public class StaffCommand implements CommandExecutor {
    ...
    private final StaffGUI gui;

    public StaffCommand(NaturalCore plugin, StaffGUI gui) {
        this.plugin = plugin;
        this.gui = gui;
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label,
        ...
        if (!player.hasPermission("naturalsmp.staff")) {
            player.sendMessage(ChatUtils.colorize("&cMaaf, kamu tidak punya izin untuk akses Staff Dashboard."));
            return true;
        }
